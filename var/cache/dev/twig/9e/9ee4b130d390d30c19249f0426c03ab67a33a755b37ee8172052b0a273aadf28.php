...
class __TwigTemplate_60c1288763bce81294a9c3bd1d2936af0b78f1f0dfeaf6f65202836b1ad85102 extends Twig_Template
{
    ...
    {
        $__internal_704b5c2622cfe6a226b62d509c608159c5bde472424ecbfa592cd7a410393c04 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_704b5c2622cfe6a226b62d509c608159c5bde472424ecbfa592cd7a410393c04->enter($__internal_704b5c2622cfe6a226b62d509c608159c5bde472424ecbfa592cd7a410393c04_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@FOSUser/Registration/register_content.html.twig"));
...
<form  method=\"post\" action=\"";
    ...
    <div class=\"login-wrap\">
        ...
        ";
        // line 41
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "fullname", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Full name", "autofocus" => "")));
        echo "
        ";
        // line 42
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "adresse", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Address", "autofocus" => "")));
        echo "
        ";
        // line 43
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "email", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Email", "autofocus" => "")));
        echo "
        <br>
        ";
        // line 45
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "genre", array()), 'widget', array("attr" => array("class" => "radios")));
        echo "
        ...
        ";
        // line 51
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "username", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Username", "autofocus" => "")));
        echo "
        ";
        // line 52
...
";
        ...
        $__internal_704b5c2622cfe6a226b62d509c608159c5bde472424ecbfa592cd7a410393c04->leave($__internal_704b5c2622cfe6a226b62d509c608159c5bde472424ecbfa592cd7a410393c04_prof);
...
", "@FOSUser/Registration/register_content.html.twig", "/Applications/MAMP/htdocs/PICharini/src/UserBundle/Resources/views/Registration/register_content.html.twig");
    }
}
